...
def configure(config: Configurator) -> None:
    """Configure Pyramid to serve the {{cookiecutter.project_slug}} API."""
    ...
    config.scan(
        ignore=[
            "{{cookiecutter.project_slug}}.conftest",
            "{{cookiecutter.project_slug}}.auth.tests",
            "{{cookiecutter.project_slug}}.profile.tests",
            "{{cookiecutter.project_slug}}.scripts.tests",
